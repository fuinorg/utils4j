...
/**
 * Represents a variable definition with name and value (both strings). Hash code and equals are defined based
 * on the name. Either value or URL has has to be defined.
 */
